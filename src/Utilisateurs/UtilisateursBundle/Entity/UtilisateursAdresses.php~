 ...
 * @ORM\Entity(repositoryClass="Utilisateurs\UtilisateursBundle\Repository\UtilisateursAdressesRepository")
 */
class UtilisateursAdresses
{
     ...
     * Set adresses
     *
     * @param \Utilisateurs\UtilisateursBundle\Entity\Utilisateurs $adresses
     * @return UtilisateursAdresses
     */
    public function setAdresses(\Utilisateurs\UtilisateursBundle\Entity\Utilisateurs $adresses = null)
    {
